...
public class MyBoxAndWhiskerRenderer extends AbstractCategoryItemRenderer 
...
Serializable {
     ...
     * Default constructor.
     */
    public MyBoxAndWhiskerRenderer() {
    ...
    public void drawVerticalItem(Graphics2D g2, 
        ...
        if (yMean != null) {
            ...
            Ellipse2D.Double avgEllipse = new Ellipse2D.Double(xx + aRadius*3, 
                    yyAverage - aRadius*2, aRadius * 2, aRadius * 2);
            g2.fill(avgEllipse);
            g2.draw(avgEllipse);
        }
    ...
    public boolean equals(Object obj) {
        ...
        MyBoxAndWhiskerRenderer that = (MyBoxAndWhiskerRenderer) obj;
